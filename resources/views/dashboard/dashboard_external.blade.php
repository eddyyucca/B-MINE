...
@section('content')
    <style>
        ...
        /* Stats Card Styling dari kode awal */
        .stats-card {
            border-radius: 8px;
            overflow: hidden;
            background-color: #fff;
        ...
        <div class="content-header">
            ...
            <section class="content">
                <div class="row">
                    ...
                    <!-- PERMIT DISTRIBUTION Section - Right Side -->
                    <div class="col-md-6">
                        <div class="section-title">
                            <i class="fas fa-chart-pie"></i> SIMPER & Mine Permit Distribution
                        </div>
                        <div class="chart-container">
                            <div class="chart-header">
                                <h3>SIMPER & Mine Permit</h3>
                ...
                <!-- OUTSTANDING PROCESS Section dari kode awal -->
                <div class="section-title">
