                            ...
                            @if (!$dataReqs->isEmpty())
                                <div class="button-group">
                                    <button type="button" class="btn btn-success mb-2" id="allApprovalBtn">
                                        <i class="fas fa-check-double"></i> Approve All KTT
                                    </button>
                                </div>
                            @endif
    ...
    <script>
        ...
        function approveRequest(action) {
            ...
            if (action === 'reject') {
                ...
                } else if (currentPage.includes('ktt')) {
                    rejectUrl = `{{ route('reject.request', '') }}/5/${activeKode}`;
                }
            ...
            $('#allApprovalBtn').on('click', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = "{{ route('approve.all.ktt') }}";
                    }
                });
            });
        });
